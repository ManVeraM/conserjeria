...
public final class QPersona extends TQRootBean<Persona,QPersona> {
  ...
  public static QPersona forFetchGroup() {
    return new QPersona(io.ebean.FetchGroup.queryFor(Persona.class));
  }
  ...
  public QPersona(io.ebean.Transaction transaction) {
    super(Persona.class, transaction);
  }

  /** Construct with a given Database */
  public QPersona(io.ebean.Database database) {
  ...
  private QPersona(io.ebean.Query<Persona> fetchGroupQuery) {
    super(fetchGroupQuery);
  }

  /** Private constructor for filterMany */
  private QPersona(io.ebean.ExpressionList<Persona> filter) {
    super(filter);
  }
  ...
  public static final class Assoc<R> extends TQAssocBean<Persona,R,QPersona> {
    ...
    public final R filterMany(java.util.function.Consumer<QPersona> apply) {

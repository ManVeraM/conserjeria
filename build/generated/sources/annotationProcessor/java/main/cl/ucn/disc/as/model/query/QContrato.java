...
public final class QContrato extends TQRootBean<Contrato,QContrato> {
  ...
  public static QContrato forFetchGroup() {
    return new QContrato(io.ebean.FetchGroup.queryFor(Contrato.class));
  }
  ...
  public QContrato(io.ebean.Transaction transaction) {
    super(Contrato.class, transaction);
  }

  /** Construct with a given Database */
  public QContrato(io.ebean.Database database) {
  ...
  private QContrato(io.ebean.Query<Contrato> fetchGroupQuery) {
    super(fetchGroupQuery);
  }

  /** Private constructor for filterMany */
  private QContrato(io.ebean.ExpressionList<Contrato> filter) {
    super(filter);
  }
  ...
  public static final class Assoc<R> extends TQAssocBean<Contrato,R,QContrato> {
    ...
    public final R filterMany(java.util.function.Consumer<QContrato> apply) {
